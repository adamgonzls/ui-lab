<script lang="ts">
  ...
  import roundTable from "$lib/assets/images/12-ecommerce-shop/round-wooden-vintage-table-389w.png"
  import redThrone from "$lib/assets/images/12-ecommerce-shop/red-and-gold-throne-chair-392w.png"
